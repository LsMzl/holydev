...
export async function PATCH(req: Request, {params}: {params: {annonceId: string}}) {
    ...
    try {
        ...
        if(!params.annonceId){
            return new NextResponse('Identifiant de l\'annonce non trouvé', {status: 401})
        }
...
export async function DELETE(req: Request,{params}: {params: {annonceId: string}}) {
