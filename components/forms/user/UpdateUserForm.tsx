...
const UpdateUserForm = ({ user }: UpdateUserProps) => {
      ...
      <Form {...form}>
         <form onSubmit={form.handleSubmit(onSubmit)}>
            <Container className="max-w-3xl flex flex-col mx-auto gap-5">
               <h3 className="text-xl font-medium mb-5">Modifier le profil</h3>
               {/* Avatar & Update */}
               ...
               />
               <Button disabled={isLoading} className="max-w-[150px] self-end">
                  {isLoading ? (
