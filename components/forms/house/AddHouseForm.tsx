      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <Container className="flex flex-col md:flex-row gap-10 p-2 md:p-0">
          ...
          <div className="flex flex-1 flex-col gap-6">
                  ...
                  <FormControl>
                    {image ? (
                      ...
                      <div className="relative max-w-[400px] min-w-[200px] max-h-[400px] min-h-[200px] mt-4">
                        ...
                        />
                        <Button
                          onClick={() => handlePictureDelete(image)}
                          type="button"
                          size="icon"
                          variant="ghost"
                          className="absolute top-0 -right-[12px]"
                        >
                          {isImageDeleted ? <Loader /> : <Trash2 />}
                        </Button>
                      </div>
                    ) : (
                      // Upload des photos
            ...
            />
            <Typography variant="body-lg" balise="h3" className="font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Etat/département <span className="text-red-500">*</span>
                    </FormLabel>
                    <FormDescription>
                      Dans quel état ou département se trouve votre logement ?
                    </FormDescription>
                    <FormControl>
                      <Select
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="5 rue de nulle part" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
